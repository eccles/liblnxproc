...
static int
proc_domainname_normalize(_TOPIARY_BASE_T *base)
{
...
int
_topiary_proc_domainname_new(_TOPIARY_BASE_T **base, TOPIARY_OPT_T *optional)
{

    char *filenames[] = { "/proc/sys/kernel/domainname" };
    int ret = _topiary_base_new(base, "proc_domainname",
