...
static int
proc_cgroups_normalize(_TOPIARY_BASE_T *base)
{
...
int
_topiary_proc_cgroups_new(_TOPIARY_BASE_T **base, TOPIARY_OPT_T *optional)
{
    ...
    ret = _topiary_base_new(base, "proc_cgroups", _TOPIARY_BASE_TYPE_VANILLA,
