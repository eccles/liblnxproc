...
extern "C" {
    ...
    typedef int (*LNXPROC_METHOD) (LNXPROC_BASE_T **base);

    typedef struct lnxproc_module_t LNXPROC_MODULE_T;

    int lnxproc_init(LNXPROC_MODULE_T ** modulesptr,
...
#define LNXPROC_FREE(b) {\
    ...
    int lnxproc_read(LNXPROC_MODULE_T * modules, LNXPROC_MODULE_TYPE_T type);

    int lnxproc_print(LNXPROC_MODULE_T * modules, LNXPROC_MODULE_TYPE_T type);
