...
static int
myarray_print(struct lnxproc_array_t *array, void *data, int idx)
{
...
main(int argc, char *argv[])
{
    ...
    struct lnxproc_array_t *array =
        lnxproc_array_new(2, 1, lnxproc_error_print_callback);
    lnxproc_array_print(array, NULL);

    printf("Allocate array 1 for strings\n");
    struct lnxproc_array_t *carray1 =
        lnxproc_array_new(2, 0, lnxproc_error_print_callback);
    lnxproc_array_print(carray1, NULL);

    printf("Allocate array 2 for strings\n");
    struct lnxproc_array_t *carray2 =
        lnxproc_array_new(2, 0, lnxproc_error_print_callback);
    lnxproc_array_print(carray2, NULL);

    printf("Allocate array 3 for strings\n");
    struct lnxproc_array_t *carray3 =
        lnxproc_array_new(2, 0, lnxproc_error_print_callback);
    ...
    if (array && carray1 && carray2 && carray3) {
        ...
        printf
            ("Add string array to struct array at position %d (should fail)\n",
             2);
        ...
        printf
            ("Add string array to struct array at position %d (should resize)\n",
             2);
        ...
        printf
            ("Get string array from struct array at position %d (should fail)\n",
             3);
