...
int _lnxproc_proc_cmdline_new(_LNXPROC_BASE_T **base, LNXPROC_OPT_T *optional);
int _lnxproc_proc_cpuinfo_new(_LNXPROC_BASE_T **base, LNXPROC_OPT_T *optional);
int _lnxproc_proc_diskstats_new(_LNXPROC_BASE_T **base,
                                LNXPROC_OPT_T *optional);
int _lnxproc_proc_domainname_new(_LNXPROC_BASE_T **base,
                                 LNXPROC_OPT_T *optional);
int _lnxproc_proc_hostname_new(_LNXPROC_BASE_T **base, LNXPROC_OPT_T *optional);
int _lnxproc_proc_interrupts_new(_LNXPROC_BASE_T **base,
                                 LNXPROC_OPT_T *optional);
int _lnxproc_proc_loadavg_new(_LNXPROC_BASE_T **base, LNXPROC_OPT_T *optional);
int _lnxproc_proc_meminfo_new(_LNXPROC_BASE_T **base, LNXPROC_OPT_T *optional);
int _lnxproc_proc_mounts_new(_LNXPROC_BASE_T **base, LNXPROC_OPT_T *optional);
int _lnxproc_proc_net_dev_new(_LNXPROC_BASE_T **base, LNXPROC_OPT_T *optional);
...
int _lnxproc_proc_net_rpc_nfsd_new(_LNXPROC_BASE_T **base,
                                   LNXPROC_OPT_T *optional);
int _lnxproc_proc_net_snmp_new(_LNXPROC_BASE_T **base, LNXPROC_OPT_T *optional);
...
int _lnxproc_proc_pid_smaps_new(_LNXPROC_BASE_T **base,
                                LNXPROC_OPT_T *optional);
int _lnxproc_proc_pid_stat_new(_LNXPROC_BASE_T **base, LNXPROC_OPT_T *optional);
int _lnxproc_proc_pid_statm_new(_LNXPROC_BASE_T **base,
                                LNXPROC_OPT_T *optional);
int _lnxproc_proc_pid_status_new(_LNXPROC_BASE_T **base,
                                 LNXPROC_OPT_T *optional);
int _lnxproc_proc_softirqs_new(_LNXPROC_BASE_T **base, LNXPROC_OPT_T *optional);
